...
Runs all rankers against a gold-labeled query set and reports NDCG@10,
MRR, and Recall@10. The default gold file is ``data/gold/queries.json``.
...
from .gold import GOLD_PATH, GoldStage, grade_for, load_gold, normalize_title
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=GOLD_PATH,
        help="Gold-label JSON file to evaluate against",
    )
    parser.add_argument(
